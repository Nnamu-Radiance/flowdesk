...
urlpatterns = [
    ...
    path("chains/<int:chain_id>/approve/", LegacyApprovalDecisionView.as_view(), {"action": "approve"}, name="approval-approve-legacy"),
    path("chains/<int:chain_id>/reject/", LegacyApprovalDecisionView.as_view(), {"action": "reject"}, name="approval-reject-legacy"),
